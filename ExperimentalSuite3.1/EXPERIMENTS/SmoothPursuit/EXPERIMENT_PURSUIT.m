...
%% EXAMPLE CODE FOR MEASURING PURSUIT EYE MOVEMENTS
clear, close all, clc
...
for trial=1:ntrials
    ...
    WaitSecs(0.5);
    for frames=1:60 
        Screen('FrameOval', win, [255 255 255], RectC+frames*(RectE-RectC)/60, penWidthPixels, penWidthPixels);
        Screen('FrameOval', win, [255 255 255], RectCs+frames*(RectEs-RectCs)/60, penWidthPixels, penWidthPixels);
        Screen('Flip', win);
    end
    for frames=1:60
        Screen('FrameOval', win, [255 255 255], RectE-frames*(RectE-RectC)/60, penWidthPixels, penWidthPixels);
        Screen('FrameOval', win, [255 255 255], RectEs-frames*(RectEs-RectCs)/60, penWidthPixels, penWidthPixels);
        Screen('Flip', win);
    end
    WaitSecs(0.5);
    Screen('Close')
...
for trial=1:ntrials
    EMD=find(EyeTimeALL>TobiStartTime(trial)+0.5 & EyeTimeALL<TobiStartTime(trial)+3);
